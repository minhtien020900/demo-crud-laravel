    ...
    <ul id="sidebar_menu">
        <li class="mm-active">
            <a class="has-arrow" href="#" aria-expanded="false">
                <!-- <i class="fas fa-th"></i> -->
                <div class="icon_menu">
                    <img src="{{asset('icons/dashboard.svg')}}" alt="Icon dashboard">
                </div>
                <span>Dashboard</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{asset('icons/manage-product.svg')}}" alt="Icon manage product">
                </div>
                <span>Products</span>
            </a>
            <ul>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <div class="icon_menu">
                    <img src="{{asset('icons/cubes.svg')}}" alt="Icon manage categories">
                </div>
                <span>UI Kits</span>
            </a>
            <ul>
